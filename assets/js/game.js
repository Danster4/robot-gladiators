...
var getPlayerName = function() {
    ...
    alert("Your robot's name is " + name);
    console.log("Your robot's name is " + name);
    return name;
};

var updateAlert = function () {
    alert(playerInfo.name + " currently has " + playerInfo.health + " health, " + playerInfo.attack + " attack strength, and " + playerInfo.money + " money.")
}
...
var shop = function() {
    // ask player what they like to do
    var shopOptionPrompt = prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please make a choice and enter: '1' for REFILL, '2' for UPGRADE, or '3' for LEAVE."
    );
